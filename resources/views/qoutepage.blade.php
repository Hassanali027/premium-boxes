...
@media (max-width: 768px) {
    ...
    .qu-breadcrumb { top: 3.5vw; left: 4vw; font-size: 3vw; }
    ...
    <section class="qu-why-section">
        ...
        <div class="qu-why-cards">
            <div class="qu-why-card">
                <div class="qu-why-icon"><i class="fas fa-recycle"></i></div>
            ...
            <div class="qu-why-card">
                <div class="qu-why-icon"><i class="fas fa-tag"></i></div>
