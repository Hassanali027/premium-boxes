...
.bp-title-l1,
.bp-title-l2 { display: block; white-space: nowrap; }
...
.bp-bio-name { font-size: 16px; font-weight: 700; color: #ffffff; display: block; margin-bottom: 4px; }
.bp-bio-text {
    padding-top: 50px;
    font-size: 13px;
    color: #888888;
...
.bp-bio-linkedin:hover { color: #ffffff; }
.bp-bio-linkedin i { font-size: 15px; color: yellow; }
...
.bp-popular-meta { display: flex; flex-direction: column; justify-content: center; overflow: hidden; }
.bp-popular-title {
    font-size: 13.5px;
    font-weight: 500;
    color: #ffffff;
...
@media (max-width: 680px) {
    ...
    .bp-mob-avatar { width: 7vw; height: 7vw; border-radius: 50%; overflow: hidden; flex-shrink: 0; }
    .bp-mob-avatar img { width: 100%; height: 100%; object-fit: cover; object-position: center top; display: block; }
    ...
    .bp-mob-read { display: flex; align-items: center; gap: 1vw; }
    .bp-mob-read i { font-size: 2.8vw; }
    ...
    .bp-bio-avatar { width: 20vw; height: 20vw; min-width: unset; margin-bottom: 0.5vw; }
    .bp-bio-content { display: contents; }
    .bp-bio-name { font-size: 4.5vw; font-weight: 700; padding-top: 0; }
    .bp-bio-text { font-size: 3.8vw; line-height: 1.8; color: #aaaaaa; margin: 0; padding: 0; }
    .bp-bio-linkedin { font-size: 3.8vw; font-weight: 600; gap: 2vw; margin-top: 1vw; }
    .bp-bio-linkedin i { font-size: 4.5vw; color: #0a66c2; }
}
    ...
    <article class="bp-hero">
        <div class="bp-container">
            ...
            <div class="bp-hero-grid bp-desktop-grid">
                ...
                <div class="bp-hero-left">
                    ...
                    <nav class="bp-breadcrumb" aria-label="Breadcrumb">
                        <a href="premiumboxes.html" class="bp-bc-home" aria-label="Home">
                            <i class="fas fa-house"></i>
                        </a>
                        <span class="bp-bc-sep"><i class="fas fa-chevron-right"></i></span>
                        <a href="blog.html" class="bp-bc-link">Blogs</a>
                        <span class="bp-bc-sep"><i class="fas fa-chevron-right"></i></span>
                        <span class="bp-bc-current">Rigid Packaging Gluing …</span>
                    </nav>

                    <h1 class="bp-title">
                        <span class="bp-title-l1">Rigid Packaging Gluing: Adhesive Types,Methods &amp;</span><br>
                        <span class="bp-title-l2">Curing</span>
                    </h1>

                    <p class="bp-desc">
                        The right box doesn't just hold your baked goods. It shows off your brand, sparks joy, and turns every treat into an experience. Get inspired by these designs that are as sweet on the outside as the treats inside.
                    </p>

                    <figure class="bp-image">
                        <img
                            src="./c903f3f775a50e5b56122d5a307158962172018e (1).jpg"
                            alt="Premium rigid packaging boxes with gold ribbon"
                            loading="eager"
                        >
                    </figure>
                ...
                <div class="bp-hero-right">
                    <div class="bp-share">
                        ...
                        <div class="bp-share-icons">
                            <a href="#" class="bp-share-btn" aria-label="Share on Facebook"><i class="fab fa-facebook-f"></i></a>
                            <a href="#" class="bp-share-btn" aria-label="Share on Instagram"><i class="fab fa-instagram"></i></a>
                            <a href="#" class="bp-share-btn" aria-label="Share on YouTube"><i class="fab fa-youtube"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="bp-author">
                        ...
                        <div class="bp-author-info">
                            <span class="bp-author-name">By Ahmed Khan</span>
                            <div class="bp-author-meta-row">
                                <span class="bp-author-date">November 14, 2025</span>
            ...
            <div class="bp-mobile">
                ...
                <h1 class="bp-mob-title">
                    Rigid Packaging Gluing:<br>
                    Adhesive Types, Methods<br>
                    &amp; Curing
                </h1>
                ...
                <div class="bp-mob-meta-row">
                    ...
                    <div class="bp-mob-author">
                        <div class="bp-mob-avatar">
                            <img src="./d05f400a89e1f73c4f46d5c97263207f8af84580 (1).png" alt="Ahmed Khan">
                        </div>
                        <div class="bp-mob-author-text">
                            <span class="bp-mob-author-name">By Ahmed Khan</span>
                            <span class="bp-mob-sep">|</span>
                            <span class="bp-mob-date">Nov 14, 2025</span>
                            <span class="bp-mob-sep">|</span>
                    ...
                    <div class="bp-mob-share">
                        ...
                        <div class="bp-mob-share-icons">
                            <a href="#" class="bp-mob-share-btn" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
                            <a href="#" class="bp-mob-share-btn" aria-label="Instagram"><i class="fab fa-instagram"></i></a>
                            <a href="#" class="bp-mob-share-btn" aria-label="YouTube"><i class="fab fa-youtube"></i></a>
                        </div>
                    </div>
            ...
            <div class="bp-hero-grid bp-body-grid">
                ...
                <div class="bp-hero-left">
                    <div class="bp-article">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus sit amet sem ut dolor vulputate dignissim sit amet id dolo. Etiam viverra sem ac erat rutrum, id feugiat nisi porttitor.</p>

                        <p>Duis nisl libero, elementum at maximus a, pretium at nisl. Vivamus dignissim fermentum. Nullam condimentum sit amet mi eu eleifend. Pellentesque blandit venenatis imperdiet.</p>

                        <p>Nulla consectetur justo elementum. Phasellus porttitor mattis turpis sed interdum. Vestibulum finibus tellus in erat, nec rhoncus arcu eleifend fermentum.</p>

                        <p>Cras consectetur suscipit tellus, et mollis nisl consectetur quis. Ut suscipit nisl id, at ornare dui feugiat vitae.</p>

                        <p>Sed neque est, interdum sit amet eleifend dignissim vel lorem. Fusce nisl malesuada nibh. Aliquam erat volutpat.</p>

                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus sit amet sem ut dolor vulputate dignissim sit amet id dolo. Etiam viverra sem ac erat rutrum.</p>
                        ...
                        <div class="bp-bio">
                            ...
                            <div class="bp-bio-content">
                                <span class="bp-bio-name">Ahmed Khan</span>
                                <p class="bp-bio-text">Writer at the Right Box Pro. Specializes in custom rigid boxes and luxury packaging solutions. With deep industry insights, design inspiration, and expert guidance to help brands create packaging that leaves a lasting impression.</p>
                                <a href="#" class="bp-bio-linkedin" aria-label="LinkedIn profile">
                ...
                <aside class="bp-sidebar">
                    <div class="bp-sidebar-sticky">
                        ...
                        <!-- TABLE OF CONTENTS -->
                        <div class="bp-sidebar-widget bp-toc-widget">
                            <h3 class="bp-toc-heading">Table of Contents</h3>
                            <nav class="bp-toc-list" id="tocList" aria-label="Table of contents">
                                <a href="#section-1" class="bp-toc-item active">Introduction to Rigid Packaging</a>
                                <a href="#section-2" class="bp-toc-item">Adhesive Types Overview</a>
                                <a href="#section-3" class="bp-toc-item">Hot Melt Adhesives</a>
                                <a href="#section-4" class="bp-toc-item">Cold Glue Methods</a>
                                <a href="#section-5" class="bp-toc-item">Spot vs Full Glue</a>
                                <a href="#section-6" class="bp-toc-item">Curing Techniques</a>
                            </nav>
                        </div>
                        ...
                        <div class="bp-sidebar-widget bp-popular-widget">
                            ...
                            <div class="bp-popular-list">
                                ...
                                <a href="#" class="bp-popular-item">
                                    <div class="bp-popular-thumb"
                                         style="background-image:url('./795621dde6787af154934c3b1e0ec13c3f0c7a6a (1).jpg')">
                                    </div>
                                    <div class="bp-popular-meta">
                                        <span class="bp-popular-title">Sustainable Packaging Trends for 2026</span>
                                        <span class="bp-popular-date">Nov 15, 2025</span>
                                    </div>
                                </a>
                                ...
                                <a href="#" class="bp-popular-item">
                                    ...
                                    <div class="bp-popular-meta">
                                        <span class="bp-popular-title">Luxury Box Design: Materials & Finishes</span>
                                        <span class="bp-popular-date">Oct 28, 2025</span>
                                    </div>
                                </a>
                                ...
                                <a href="#" class="bp-popular-item">
                                    ...
                                    <div class="bp-popular-meta">
                                        <span class="bp-popular-title">Corrugated vs Rigid: Which to Choose?</span>
                                        <span class="bp-popular-date">Oct 10, 2025</span>
                                    </div>
                                </a>
                                ...
                                <a href="#" class="bp-popular-item">
                                    ...
                                    <div class="bp-popular-meta">
                                        <span class="bp-popular-title">Foil Stamping Techniques for Premium Boxes</span>
                                        <span class="bp-popular-date">Sep 22, 2025</span>
                                    </div>
                                </a>
                ...
                <article class="bp-related-card">
                    ...
                    <div class="bp-related-body">
                        <div class="bp-related-meta">
                            <span class="bp-related-author">Joe Danley</span>
                            <span class="bp-related-date">Nov 15, 2024</span>
                        </div>
                        <h3 class="bp-related-title">Sustainable Packaging Trends for 2026</h3>
                        <p class="bp-related-desc">Explore how eco-friendly rigid boxes are transforming luxury packaging with sustainable materials and premium finishes.</p>
                    </div>
                </article>
...
(function () {
    ...
    // Build section targets from TOC hrefs
    ...
    function onScroll() {
        const scrollY = window.scrollY + 160; // offset for sticky top
